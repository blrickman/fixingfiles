...
if (0) {
   ...
   $pm_b = 1.8258141203642293 / 1000;
   $pm_c = 0.41922305621512435* 1000;
   $pm_d = 42.697578590972284 / 1000;
   $pm_e = 0.23122817596631087* 1000;
   $pm_f = 16.856140662231493 / 1000;
   $pm_g = 0.0012595318887451284 * 10**6;
   $pm_h = 28.65;
}
